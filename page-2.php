...
<body>
    ...
    <?php
        $url = 'https://newsapi.org/v2/top-headlines?country=mx&category=technology&pageSize=10&page=2&apiKey=c56f43f0a5fb46f1ab6891dd9793e37e';
        $url2 = 'https://randomuser.me/';
    ...
    <nav aria-label="...">
        <ul class="pagination">
            <li class="page-item">
            <a class="page-link" href="index.php" tabindex="-1">Anterior</a>
            </li>
            <li class="page-item">
            <a class="page-link" href="index.php">1 <span class="sr-only"></span></a>
            </li>
            <li class="page-item active"><a class="page-link" href="page-2.php">2</a></li>
            <li class="page-item"><a class="page-link" href="page-3.php">3</a></li>
            <li class="page-item">
            <a class="page-link" href="page-3.php">Siguiente</a>
            </li>
        </ul>
    </nav>
