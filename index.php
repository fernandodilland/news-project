...
<body>
    ...
    <?php
        $url = 'https://newsapi.org/v2/top-headlines?country=mx&category=technology&pageSize=10&page=1&apiKey=c56f43f0a5fb46f1ab6891dd9793e37e';
    ...
    <nav aria-label="...">
        <ul class="pagination">
            ...
            <li class="page-item">
            <a class="page-link" href="page-2.php">Siguiente</a>
            </li>
        </ul>
    </nav>
